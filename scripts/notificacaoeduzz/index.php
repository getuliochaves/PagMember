...
if($chaveApi == $token){
	...
	$idTransacao = $_POST['edz_fat_cod'];
	$idProd = $_POST['edz_cnt_cod'];
	$nomeCli = $_POST['edz_cli_rsocial'];
	$emailCli = $_POST['edz_cli_email'];
	$valorProd = $_POST['edz_valorpago'];
	$nomeProd = $_POST['edz_cnt_titulo'];
	$statusTrasacao = $_POST['edz_fat_status'];
	...
	case '1': $statusCompra = 'Aguardando pagamento';
		...
		case '8': $statusCompra = 'Aguardando pagamento';
			$statusTrasacaoOk = 1;
			break;
		...
		case '11': $statusCompra = 'Aguardando pagamento';
			$statusTrasacaoOk = 1;
			break;

		case '4': $statusCompra = 'Cancelada';
			$statusTrasacaoOk = 6;
		break;
...
$transacaoUsuario['senhaUsu'] = base64_encode($senhaUsu);
	...
	if($enviaDados == 'sim'){
		...
		if($tipoMetodo == 'SemAutenticacao'){
			...
			$dadosMS = wp_mail($emailCli, $assuntoEnvio, $Mensagem, $headers);
			var_dump($dadosMS);
...
var_dump($emailEnvioRE);
var_dump($tipoAutenticacao);
